## Script to plot PCA from covariance matrix (made by genotype estimates from Entropy)
## USAGE: Rscript PCAentropy.R <covariance.csv> <annotation.filelist> <out.png> 
...
PC$Predicted <- factor(annot$PREDICTED)
...
ggsave(gsub('pdf$','png',outFile),device = "png", width = 8, height = 5)
